    ...
    return (
      <div className="max-w-3xl mx-auto mt-20 p-12 bg-surface rounded-2xl border border-border-main shadow-sm text-center">
        ...
        <p className="text-text-muted">
          This feature is not available in your website. Only Super
          Administrators can access the role management portal.
        </p>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-text-muted text-sm mt-1">
            Super Admin portal for assigning permissions and roles.
          </p>
        </div>
      </div>
              ...
              : users.map((u) => (
                  <tr key={u.id} className="hover:bg-zinc-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      ...
                      {updating === u.id && (
                        <Loader2 className="w-4 h-4 ml-2 inline animate-spin text-text-muted" />
                      )}
                    </td>
                  </tr>
                ))}
